...
by default.
`host`:: (Optional) Required if `in_cluster` is false, host must match your kubectl
context name. You can find your current context name by running
